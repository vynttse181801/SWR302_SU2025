      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/appointment" className="text-gray-300 hover:text-primary-400 transition-colors text-sm">Đặt lịch khám</Link></li>
              <li><Link to="/test-results" className="text-gray-300 hover:text-primary-400 transition-colors text-sm">Kết quả xét nghiệm</Link></li>
              <li><Link to="/medication" className="text-gray-300 hover:text-primary-400 transition-colors text-sm">Quản lý thuốc ARV</Link></li>
